...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Welcome to Laravel Vagrant machine!</title>
    ...
    <body>
        <div class="center logo">
            ...
            <h1 class="center header">Welcome to Laravel Vagrant phpinfo!</h1>
            <table>
                <tbody>
                    <tr class="h">
                        <td>
                            <a class="nav" href="https://github.com/uonick/laravel-vm">Repository</a>
                            <a class="nav" href="https://laravel.com/">Laravel</a>
                            <a class="nav" href="https://laravel.com/docs/master">Laravel Docs</a>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <style type="text/css">
        *,html,body{font-family:'Lato',sans-serif;font-size:1em;-webkit-font-smoothing:antialiased;text-shadow:1px 1px 1px rgba(0,0,0,.004);text-rendering:optimizeLegibility}.h{background:#f4645f;color:#fff}.e{color:#f4645f;background-color:#fff}.v{background-color:#fff;font-family:monospace;font-size:1em}td a img{display:none}.header{margin-bottom:3em}.logo{margin-top:3em}a.nav{font-size:1.5em;color:#fff;background-color:#f4645f;margin-right:2em}td,th{border:1px solid #ccc}
        </style>
    </body>
</html>
